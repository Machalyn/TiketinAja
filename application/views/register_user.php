                    ...
                    <div class="p-5">
                        ...
                        <form class="user" method="post" action="<?= base_url('User/register'); ?>">
                            <div class="form-group">
                                <input type="text" class="form-control form-control-user" id="nama" name="nama" placeholder="Masukkan Nama Anda" value="<?= set_value('nama'); ?>">
                                <?= form_error('nama', '<small class="text-danger pl-3" >', '</small>'); ?>
                                <!-- warning kalau misalkan kosong -->
